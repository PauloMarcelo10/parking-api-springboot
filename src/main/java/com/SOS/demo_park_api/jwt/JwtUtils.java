package com.SOS.demo_park_api.jwt;
...
public class JwtUtils {
    ...
    private static final long EXPIRE_MINUTES = 35;
    ...
    public static <role> JwtToken createToken(String s, String username, String role) {
