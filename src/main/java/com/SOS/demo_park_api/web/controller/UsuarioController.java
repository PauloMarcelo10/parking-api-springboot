...
import com.SOS.demo_park_api.entity.Usuario;
import com.SOS.demo_park_api.service.UsuarioService;
...
import com.SOS.demo_park_api.web.DTO.mapper.UsuarioMapper;
...
@Tag(name = "Usuarios", description = "Contém todas as operações relativas aos recursos para cadastros, edições e leitura de um usuário.")
...
public class UsuarioController {
    ...
    @Operation(summary = "Recuperar um usuário pelo id", description = "Requisição exige um Bearer Token. Acesso restrito a ADMIN|CLIENTE",
            ...
            responses = {
                    @ApiResponse(responseCode = "200", description = "Rescurso recuperado com sucesso",
                            content = @Content(mediaType = "application/json", schema = @Schema(implementation = UsuarioResponseDto.class))),
