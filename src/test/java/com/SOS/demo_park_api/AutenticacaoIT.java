...
import com.SOS.demo_park_api.jwt.JwtToken;
import com.SOS.demo_park_api.web.DTO.UsuarioLoginDto;
...
public class AutenticacaoIT {
    ...
    public void autenticar_ComCredenciaisValidas_RetornarTokenComStatus200() {
        JwtToken responseBody = testClient
                ...
                .bodyValue(new UsuarioLoginDto("carlos@email.com", "123456"))
                .exchange()
                .expectStatus().isOk()
    ...
    public void autenticar_ComCredenciaisInvalidas_RetornarErrorMessageStatus400() {
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioLoginDto("carlos@email.com", "000000"))
                .exchange()
                .expectStatus().isBadRequest()
                .expectBody(ErrorMessage.class)
                .returnResult()
    ...
    public void autenticar_ComPasswordInvalido_RetornarErrorMessageStatus422() {
        ErrorMessage responseBody = testClient
                ...
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioLoginDto("carlos@email.com", ""))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult()
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioLoginDto("carlos@email.com", "123"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult()
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioLoginDto("carlos@email.com", "123456789"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult()
