...
public class ClienteIT {
    ...
    public void criarCliente_ComDadosValidos_RetornarClienteComStatus201() {
        ...
        ClienteResponseDto responseBody = testClient
                ...
                .bodyValue(new ClienteCreateDto("Tobias Ferreira", "73917824086"))
                .exchange()
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getCpf()).isEqualTo("73917824086");
    ...
    public void criarCliente_ComCpfJaCadastrado_RetornarErrorMessageStatus409() {
        ...
        ErrorMessage responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "toby@email.com", "123456"))
                .bodyValue(new ClienteCreateDto("Tobias Ferreira", "38490739048"))
                .exchange()
    ...
    public void criarCliente_ComDadosInvalidos_RetornarErrorMessageStatus422() {
        ...
        responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "toby@email.com", "123456"))
                .bodyValue(new ClienteCreateDto("Bobb", "384.907.390-48"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    @Test
    public void buscarCliente_ComDadosDoTokenDeCliente_RetornarClienteComStatu200() {
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody).isNotNull();
        org.assertj.core.api.Assertions.assertThat(responseBody.getCpf()).isEqualTo("34264709008");
    ...
    @Test
    public void buscarCliente_ComDadosDoTokenDeAdministrador_RetornarErrorMessageComStatu403() {
