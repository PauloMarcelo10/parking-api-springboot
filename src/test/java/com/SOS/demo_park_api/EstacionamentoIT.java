...
public class EstacionamentoIT {
    ...
    public void criarCheckin_ComDadosValidos_RetornarCreatedAndLocation() {
        EstacionamentoCreateDto createDto = EstacionamentoCreateDto.builder()
                ...
                .cor("AZUL").clienteCpf("34264709008")
                .build();
        ...
        testClient.post().uri("/api/v1/estacionamentos/check-in")
                ...
                .jsonPath("clienteCpf").isEqualTo("34264709008")
    ...
    public void criarCheckin_ComCpfInexistente_RetornarErrorStatus404() {
        EstacionamentoCreateDto createDto = EstacionamentoCreateDto.builder()
                .placa("WER-1111").marca("FIAT").modelo("PALIO 1.0")
                .cor("AZUL").clienteCpf("05828368087")
                .build();
    ...
    public void buscarCheckin_ComPerfilAdmin_RetornarDadosStatus200() {
        ...
        testClient.get()
                ...
                .jsonPath("clienteCpf").isEqualTo("38490739048")
    ...
    public void buscarEstacionamentos_PorClienteCpf_RetornarSucesso() {
        ...
        PageableDto responseBody = testClient.get()
                .uri("/api/v1/estacionamentos/cpf/{cpf}?size=1&page=0", "38490739048")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "carlos@email.com", "123456"))
                .exchange()
                .expectStatus().isOk()
        ...
        responseBody = testClient.get()
                .uri("/api/v1/estacionamentos/cpf/{cpf}?size=1&page=1", "38490739048")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "carlos@email.com", "123456"))
                .exchange()
                .expectStatus().isOk()
                .expectBody(PageableDto.class)
    ...
    public void buscarEstacionamentos_PorClienteCpfComPerfilCliente_RetornarErrorStatus403() {
        ...
        testClient.get()
                .uri("/api/v1/estacionamentos/cpf/{cpf}", "38490739048")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "guilherme@email.com", "123456"))
                .exchange()
                .expectStatus().isForbidden()
                .expectBody()
                .jsonPath("status").isEqualTo("403")
                .jsonPath("path").isEqualTo("/api/v1/estacionamentos/cpf/38490739048")
                .jsonPath("method").isEqualTo("GET");
    }
